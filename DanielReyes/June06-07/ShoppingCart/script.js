// Objects
const items = {
    0 : ["Cap", 20, "https://img.fruugo.com/product/2/80/230264802_max.jpg"],
    1 : ["Tshirt", 50, "https://cdn.shopify.com/s/files/1/1002/7150/products/New-Mockups---no-hanger---TShirt-Yellow.jpg?v=1639657077"],
    2 : ["Shorts",30, "https://contents.mediadecathlon.com/p1985538/6857946ffb8dd831ed1aec6281115426/p1985538.jpg"]
}
...
function addItemToCart(e) {
    ...
    if(cart[itemId]){
        ...
        equivalentPrice.innerText = "$" + cart[itemId] * items[itemId][1];
    } else{
        cart[itemId] = 1;
        ...
        item.innerText = items[itemId][0];
        item.classList.add("itemName");
        cartItem.appendChild(item);
        const image = document.createElement("img");
        image.src = items[itemId][2];
        image.alt = items[itemId][0];
        cartItem.appendChild(image);
        const price = document.createElement("p");
        price.classList.add("price");
        price.innerText = "$" + items[itemId][1];
        ...
        equivalentPrice.innerText = "$" + (items[itemId][1]);
